...
/**
 * @Class Name : EgovProductService.java
 * @Description : EgovProductService Class
...
public interface ProductService {
	 ...
	 * @exception Exception
	 */
	UserVO login(String id, String password) throws Exception;
	 ...
	 * @exception Exception
	 */
	UserVO kakaoLogin(String id, String email) throws Exception;
	 ...
	 * @exception Exception
	 */
	UserVO naverLogin(String id, String email) throws Exception;
