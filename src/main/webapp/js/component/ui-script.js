...
const krds_mainMenuPC = {
  init() {
    const gnbMenu = document.querySelector(".krds-main-menu:not(.Product) .gnb-menu");
  ...
  resetMainMenu() {
    document.querySelectorAll(".krds-main-menu:not(.Product) .gnb-main-trigger:not(.is-link)").forEach((mainTrigger) => {
      mainTrigger.classList.remove("active");
      mainTrigger.setAttribute("aria-expanded", "false");
    });
    document.querySelectorAll(".krds-main-menu:not(.Product) .gnb-toggle-wrap").forEach((toggleWrap) => {
...
const krds_mainMenuMobile = {
  init() {
    const mobileGnb = document.querySelector(".krds-main-menu-mobile:not(.Product)");
...
const krds_modal = {
  ...
  closeModal(id) {
    const modalElement = document.getElementById(id);
    const openModals = document.querySelectorAll(".modal.in:not(.Product)");
    const modalBack = modalElement.querySelector(".modal-back");
...
const krds_inPageNavigation = {
  ...
  init() {
    this.quickIndicators = document.querySelectorAll(".krds-in-page-navigation-type .krds-in-page-navigation-area:not(.Product) .in-page-navigation-list");
  ...
  updateActiveSection() {
    ...
    let sectionArea = [];
    const activeTab = document.querySelector(".tab-conts:not(.Product).active");
...
const krds_dropEvent = {
  dropButtons: null,
  init() {
    this.dropButtons = document.querySelectorAll(".krds-drop-wrap:not(.Product) .drop-btn");
